        ...
        <AnimatePresence mode="wait" custom={direction}>
          ...
          {currentStep === 0 && (
            <motion.div
              ...
              className="w-full"
            >
              <div className="relative rounded-3xl overflow-hidden border border-neon-cyan/25 shadow-tactical-card p-8 sm:p-12 text-center bg-night-deep/90">
                
                {/* Overlay y Luces */}
                <div className="absolute inset-0 bg-gradient-to-t from-night-deep via-night-deep/80 to-transparent z-10" />
                <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-neon-cyan/10 rounded-full blur-3xl pointer-events-none" />
          ...
          {currentStep === 1 && (
            <motion.div
              ...
              className="w-full"
            >
              <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-white/15 shadow-tactical-card">
                ...
                <div className="flex justify-between items-center pt-4 border-t border-white/10">
                  ...
                  <button
                    type="button"
                    onClick={() => goToStep(2)}
                    className="flex items-center gap-2 px-6 py-3 rounded-xl bg-neon-cyan text-night-deep font-rajdhani font-bold text-sm uppercase tracking-wider shadow-cyan-glow hover:bg-cyan-300 transition-all"
                  >
